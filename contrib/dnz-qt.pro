...
RESOURCES += src/qt/dnz.qrc src/qt/dnz_locale.qrc

TRANSLATIONS += src/qt/locale/dnz_bg.ts \
                src/qt/locale/dnz_de.ts \
                src/qt/locale/dnz_en.ts \
                src/qt/locale/dnz_es.ts \
                src/qt/locale/dnz_fi.ts \
                src/qt/locale/dnz_fr.ts \
                src/qt/locale/dnz_it.ts \
                src/qt/locale/dnz_ja.ts \
                src/qt/locale/dnz_pl.ts \
                src/qt/locale/dnz_pt.ts \
                src/qt/locale/dnz_ru.ts \
                src/qt/locale/dnz_sk.ts \
                src/qt/locale/dnz_sv.ts \
                src/qt/locale/dnz_vi.ts \
                src/qt/locale/dnz_zh_CN.ts \
                src/qt/locale/dnz_zh_TW.ts
