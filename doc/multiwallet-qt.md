...
In order to support loading of multiple wallets in dnz-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dnz.cpp.
...
Changes to dnz.cpp
----------------------
dnz.cpp is the entry point into dnz-qt, and as such, will require some minor modifications to provide hooks for
