                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ADENZ-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DNZ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dnz: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DNZ Core"), this);
    aboutAction->setStatusTip(tr("Show information about DNZ Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DNZ"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DNZ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DNZ addresses"));
    ...
    openAction->setStatusTip(tr("Open a DNZ: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DNZ Core help message to get a list with possible DNZ command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DNZ Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DNZ network", "", count));
}
...
{
    QString strTitle = tr("DNZ Core"); // default title
