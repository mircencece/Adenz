...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DNZ features */
        {"dnz", "masternode", &masternode, true, true, false},
        {"dnz", "masternodelist", &masternodelist, true, true, false},
        {"dnz", "mnbudget", &mnbudget, true, true, false},
        {"dnz", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"dnz", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dnz", "mnsync", &mnsync, true, true, false},
        {"dnz", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dnzd, or the -server option to dnz-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dnz-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8938/\n";
}
