...
#if defined(NDEBUG)
#error "DNZ cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "DNZ Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight > 1 && nHeight <= 5100) {
		nSubsidy = 1 * COIN;
	} else if (nHeight > 5100 && nHeight <= 22000) {
		nSubsidy = 51 * COIN;
	} else if (nHeight > 22000 && nHeight <= 33000) {
		nSubsidy = 61 * COIN;
	} else if (nHeight > 33000 && nHeight <= 44000) {
		nSubsidy = 71 * COIN;
	} else if (nHeight > 44000 && nHeight <= 55000) {
		nSubsidy = 41 * COIN;
	} else if (nHeight > 55000 && nHeight <= 66000) {
		nSubsidy = 31 * COIN;
	} else {
		nSubsidy = 21 * COIN;
	}
