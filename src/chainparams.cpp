...
{
    const char* pszTimestamp = "adenz.org blockchain";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
		(0, uint256("0x0000081c716b68a149ca25537a6d8470c4b1c58fe701cf77362b1c0ff4f3d497"))
		;
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1534395831, 20734463, 0x1e0ffff0, 1, 0 * COIN);

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x0000081c716b68a149ca25537a6d8470c4b1c58fe701cf77362b1c0ff4f3d497"));
        assert(genesis.hashMerkleRoot == uint256("0x408baace3605f0ab6d9546f8bac48a807aa62a6160170cd95118da9519466f71"));
		
	vSeeds.push_back(CDNSSeedData("s1.adenz.org", "s1.adenz.org"));
	vSeeds.push_back(CDNSSeedData("s2.adenz.org", "s2.adenz.org"));
	vSeeds.push_back(CDNSSeedData("s3.adenz.org", "s3.adenz.org"));
	...
	nStartMasternodePayments = 1534395831; 
